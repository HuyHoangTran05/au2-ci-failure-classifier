...
- Created: 2026-09-15T04:55:12+00:00
...
| --- | --- | --- | --- |
| rules | 62 | 0.35 [0.14, 0.60] | 0.50 [0.23, 0.60] |
| tfidf | 62 | 0.32 [0.16, 0.52] | 0.19 [0.11, 0.36] |
| llm | 62 | 0.69 [0.51, 0.86] | 0.71 [0.52, 0.84] |
| hybrid | 62 | 0.71 [0.53, 0.87] | 0.70 [0.52, 0.84] |
...
| rules vs llm | 62 | 3 | 24 | 4.9e-05 |
| rules vs hybrid | 62 | 2 | 24 | 1e-05 |
| tfidf vs llm | 62 | 7 | 30 | 0.00019 |
| tfidf vs hybrid | 62 | 6 | 30 | 7e-05 |
...
| --- | --- | --- | --- | --- | --- |
| rules | 5 | 194 | 0.41 ± 0.19 | 0.45 ± 0.18 | 0.49 |
| tfidf | 5 | 194 | 0.49 ± 0.08 | 0.35 ± 0.07 | 0.06 |
| llm | 5 | 104 | 0.58 ± 0.21 | 0.61 ± 0.18 | 0.10 |
| hybrid | 5 | 104 | 0.61 ± 0.18 | 0.63 ± 0.17 | 0.03 |

> llm is scored only on the 104 samples that already have stored answers (`llm-run`).
> hybrid is scored only on the 104 samples that already have stored answers (`llm-run`).

## Baseline 1 - keyword rules

- Accuracy: **0.35** (unknown counts as wrong)
...
| test_assertion | 0.91 | 0.56 | 0.69 | 18 | 11 |
...
- Accuracy: **0.32** (unknown counts as wrong)
- Abstention rate (predicted unknown): 0.00
- Accuracy when answered: 0.32
- Macro F1: 0.19
- Runtime: 1.8 ms/sample

| Category | Precision | Recall | F1 | Support | Predicted |
| --- | --- | --- | --- | --- | --- |
| compilation | 0.00 | 0.00 | 0.00 | 5 | 7 |
| test_assertion | 0.54 | 0.83 | 0.65 | 18 | 28 |
| dependency | - | 0.00 | 0.00 | 5 | 0 |
| authentication | 0.00 | 0.00 | 0.00 | 6 | 10 |
| infrastructure | 1.00 | 0.20 | 0.33 | 10 | 2 |
...
| test_assertion | 1 | 15 | 0 | 0 | 0 | 2 | 0 |
| dependency | 0 | 2 | 0 | 0 | 0 | 3 | 0 |
| authentication | 6 | 0 | 0 | 0 | 0 | 0 | 0 |
| infrastructure | 0 | 0 | 0 | 1 | 2 | 7 | 0 |
| other | 0 | 6 | 0 | 9 | 0 | 3 | 0 |
...
- Accuracy: **0.69** (unknown counts as wrong)
...
| test_assertion | 0.93 | 0.78 | 0.85 | 18 | 15 |
| dependency | 0.38 | 0.60 | 0.46 | 5 | 8 |
| authentication | 0.75 | 1.00 | 0.86 | 6 | 8 |
| infrastructure | 0.83 | 0.50 | 0.62 | 10 | 6 |
...
| test_assertion | 1 | 14 | 0 | 0 | 1 | 1 | 1 |
| dependency | 1 | 0 | 3 | 1 | 0 | 0 | 0 |
| authentication | 0 | 0 | 0 | 6 | 0 | 0 | 0 |
| infrastructure | 0 | 0 | 0 | 0 | 5 | 0 | 5 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| compilation | 5 | 0 | 0 | 0 | 0 | 0 | 0 |
| test_assertion | 1 | 15 | 0 | 0 | 1 | 1 | 0 |
| dependency | 1 | 0 | 3 | 1 | 0 | 0 | 0 |
| authentication | 0 | 0 | 0 | 6 | 0 | 0 | 0 |
| infrastructure | 0 | 0 | 0 | 0 | 5 | 5 | 0 |
| other | 1 | 1 | 5 | 1 | 0 | 10 | 0 |
