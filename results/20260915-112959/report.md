...
- Created: 2026-09-15T04:29:59+00:00
...
| --- | --- | --- | --- | --- |
| rules vs tfidf | 291 | 26 | 105 | 1.9e-12 |
| rules vs llm | 291 | 17 | 137 | 1.7e-24 |
| rules vs hybrid | 291 | 10 | 139 | 3.3e-30 |
...
| hybrid | 5 | 293 | 0.75 ± 0.06 | 0.60 ± 0.06 | 0.00 |

> llm is scored only on the 293 samples that already have stored answers (`llm-run`).
> hybrid is scored only on the 293 samples that already have stored answers (`llm-run`).
