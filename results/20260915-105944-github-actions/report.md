...
- Created: 2026-09-15T03:59:44+00:00
...
| tfidf | 62 | 0.10 [0.01, 0.23] | 0.08 [0.02, 0.18] |
...
| --- | --- | --- | --- | --- |
| rules vs tfidf | 62 | 17 | 0 | 1.5e-05 |
| rules vs llm | 62 | 4 | 24 | 0.00018 |
| tfidf vs llm | 62 | 3 | 40 | 3e-09 |
...
| tfidf | 5 | 194 | 0.04 ± 0.05 | 0.05 ± 0.07 | 0.93 |
...
- Accuracy: **0.10** (unknown counts as wrong)
- Abstention rate (predicted unknown): 0.76
- Accuracy when answered: 0.40
- Macro F1: 0.08
- Runtime: 5.2 ms/sample

| Category | Precision | Recall | F1 | Support | Predicted |
| --- | --- | --- | --- | --- | --- |
| compilation | - | 0.00 | 0.00 | 5 | 0 |
| test_assertion | 1.00 | 0.33 | 0.50 | 18 | 6 |
...
- `microsoft__vscode__31959446031` label=compilation predicted=unknown - p=0.33
- `microsoft__vscode__31971380461` label=test_assertion predicted=unknown - p=0.30
- `microsoft__vscode__31973112831` label=test_assertion predicted=unknown - p=0.29
- `microsoft__vscode__31975340271` label=compilation predicted=unknown - p=0.26
