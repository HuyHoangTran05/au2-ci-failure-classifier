...
- Created: 2026-09-15T04:30:27+00:00
...
| --- | --- | --- | --- | --- |
| rules vs tfidf | 62 | 14 | 11 | 0.69 |
| rules vs llm | 62 | 4 | 24 | 0.00018 |
| rules vs hybrid | 62 | 3 | 24 | 4.9e-05 |
...
| --- | --- | --- | --- | --- | --- |
| rules | 5 | 194 | 0.29 ± 0.14 | 0.37 ± 0.14 | 0.54 |
| tfidf | 5 | 194 | 0.49 ± 0.08 | 0.35 ± 0.07 | 0.06 |
| llm | 4 | 64 | 0.73 ± 0.27 | 0.70 ± 0.32 | 0.09 |
| hybrid | 4 | 64 | 0.75 ± 0.25 | 0.70 ± 0.32 | 0.06 |

> llm is scored only on the 64 samples that already have stored answers (`llm-run`).
> hybrid is scored only on the 64 samples that already have stored answers (`llm-run`).
