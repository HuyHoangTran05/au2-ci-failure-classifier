...
- Created: 2026-09-15T04:54:44+00:00
...
| --- | --- | --- | --- |
| rules | 291 | 0.34 [0.23, 0.46] | 0.40 [0.22, 0.52] |
| tfidf | 291 | 0.57 [0.44, 0.69] | 0.29 [0.22, 0.44] |
| llm | 291 | 0.71 [0.59, 0.80] | 0.67 [0.50, 0.76] |
| hybrid | 291 | 0.74 [0.62, 0.83] | 0.67 [0.50, 0.76] |
...
| --- | --- | --- | --- | --- |
| rules vs tfidf | 291 | 23 | 89 | 2.4e-10 |
| rules vs llm | 291 | 24 | 131 | 4.9e-19 |
| rules vs hybrid | 291 | 17 | 133 | 1.7e-23 |
| tfidf vs llm | 291 | 33 | 74 | 9.2e-05 |
| tfidf vs hybrid | 291 | 24 | 74 | 4.2e-07 |
...
| --- | --- | --- | --- | --- | --- |
| rules | 5 | 944 | 0.42 ± 0.09 | 0.51 ± 0.10 | 0.48 |
| tfidf | 5 | 944 | 0.62 ± 0.07 | 0.42 ± 0.11 | 0.00 |
| llm | 5 | 333 | 0.70 ± 0.08 | 0.62 ± 0.09 | 0.08 |
| hybrid | 5 | 333 | 0.73 ± 0.06 | 0.62 ± 0.10 | 0.00 |
...
| test_assertion | 0.78 | 0.63 | 0.70 | 103 | 83 |
| dependency | 1.00 | 0.19 | 0.32 | 32 | 6 |
| authentication | 1.00 | 0.60 | 0.75 | 10 | 6 |
| infrastructure | 0.00 | 0.00 | 0.00 | 21 | 1 |
| other | 0.92 | 0.12 | 0.22 | 96 | 13 |

By source:

| Source | Samples | Accuracy | Abstention rate |
| --- | --- | --- | --- |
| github-actions | 55 | 0.29 | 0.62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| compilation | 10 | 9 | 0 | 0 | 1 | 0 | 9 |
| test_assertion | 0 | 65 | 0 | 0 | 0 | 1 | 37 |
| dependency | 4 | 2 | 6 | 0 | 0 | 0 | 20 |
| authentication | 0 | 4 | 0 | 6 | 0 | 0 | 0 |
| infrastructure | 0 | 0 | 0 | 0 | 0 | 0 | 21 |
| other | 2 | 3 | 0 | 0 | 0 | 12 | 79 |
...
- Macro F1: 0.29
- Runtime: 2.3 ms/sample

| Category | Precision | Recall | F1 | Support | Predicted |
| --- | --- | --- | --- | --- | --- |
| compilation | 0.14 | 0.07 | 0.09 | 29 | 14 |
| test_assertion | 0.60 | 0.87 | 0.71 | 103 | 150 |
| dependency | 0.40 | 0.06 | 0.11 | 32 | 5 |
| authentication | 0.00 | 0.00 | 0.00 | 10 | 10 |
| infrastructure | 1.00 | 0.10 | 0.17 | 21 | 2 |
| other | 0.63 | 0.72 | 0.67 | 96 | 110 |

By source:

| Source | Samples | Accuracy | Abstention rate |
| --- | --- | --- | --- |
| github-actions | 55 | 0.36 | 0.00 |
...
| label \ predicted | compilation | test_assertion | dependency | authentication | infrastructure | other | unknown |
| --- | --- | --- | --- | --- | --- | --- | --- |
| compilation | 2 | 19 | 1 | 0 | 0 | 7 | 0 |
| test_assertion | 1 | 90 | 2 | 0 | 0 | 10 | 0 |
| dependency | 2 | 15 | 2 | 0 | 0 | 13 | 0 |
| authentication | 7 | 0 | 0 | 0 | 0 | 3 | 0 |
| infrastructure | 0 | 10 | 0 | 1 | 2 | 8 | 0 |
| other | 2 | 16 | 0 | 9 | 0 | 69 | 0 |

Examples of mistakes:

- `logchunks__processone__ejabberd__555702367` label=authentication predicted=other - p=0.23
- `logchunks__processone__ejabberd__557756393` label=authentication predicted=compilation - p=0.29
- `logchunks__processone__ejabberd__566947386` label=authentication predicted=other - p=0.24
- `logchunks__processone__ejabberd__570754006` label=authentication predicted=other - p=0.23
...
| --- | --- | --- | --- | --- | --- |
| compilation | 0.65 | 0.69 | 0.67 | 29 | 31 |
| test_assertion | 0.78 | 0.87 | 0.82 | 103 | 116 |
| dependency | 0.69 | 0.69 | 0.69 | 32 | 32 |
| authentication | 0.75 | 0.60 | 0.67 | 10 | 8 |
| infrastructure | 0.40 | 0.38 | 0.39 | 21 | 20 |
| other | 0.82 | 0.72 | 0.77 | 96 | 84 |

By source:

| Source | Samples | Accuracy | Abstention rate |
| --- | --- | --- | --- |
| github-actions | 55 | 0.67 | 0.00 |
| github-actions (targeted-auth) | 7 | 1.00 | 0.00 |
| logchunks | 229 | 0.75 | 0.00 |

Confusion matrix (rows = label, columns = prediction):

| label \ predicted | compilation | test_assertion | dependency | authentication | infrastructure | other | unknown |
| --- | --- | --- | --- | --- | --- | --- | --- |
| compilation | 20 | 2 | 0 | 0 | 1 | 6 | 0 |
| test_assertion | 2 | 90 | 3 | 0 | 4 | 4 | 0 |
| dependency | 7 | 2 | 22 | 1 | 0 | 0 | 0 |
| authentication | 1 | 0 | 0 | 6 | 3 | 0 | 0 |
| infrastructure | 0 | 8 | 0 | 0 | 8 | 5 | 0 |
| other | 1 | 14 | 7 | 1 | 4 | 69 | 0 |
